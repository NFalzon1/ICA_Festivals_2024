    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main">
            <section class="courses-list">
                <div class="container">
                    <h2 class="content-header">Courses</h2> <!-- Adjust header styles -->
                    <style>
                        .content-header {
                            color: white;
                            text-align: left;
...
=======
                            ...
                            color: black; /* Make link title black */
                        }
                        .course-container {
                            display: flex;
                            flex-wrap: wrap;
...
<<<<<<< Updated upstream
                                        <?php if ($course_image): ?>
                                            <img src="<?php echo esc_url($course_image['url']); ?>"
                                                data-hover="<?php echo esc_url($course_image_hover['url']); ?>"
                                        ...
                                        <div class="card-body">
                                            <div class="course-title">
                                                ...
                                                <h5 style="font-weight: bold; font-style: italic;"><a
...
=======
                                        ...
                                        <div class="card-body">
                                            <div class="course-title">
                                                <h5 class="text-center"><a href="<?php the_permalink(); ?>">Bachelor of Arts (Hons) in</a></h5>
                                                <h5 class="text-center" style="font-weight: bold; font-style: italic;"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h5>
>>>>>>> Stashed changes
                                            </div>
                                        </div>
                                    </div>
